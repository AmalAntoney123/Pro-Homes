            ...
            <div class="">
                <div class="row p-5">
                    <div class="col-lg-5 col-12">
                        <div class="ps-md-4 shadow-sm mx-2 pt-5 pb-5 mb-5 my-2 bg-white" style="border-radius:20px;">
                            <div class="d-flex flex-column align-items-center">
                                <div class="row">
                                    <img class="photo" src="uploads/<?php echo $target; ?>" alt=""
                                        class="img-fluid">
                                </div>
                                        ...
                                        <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                            <form action="update_profile.php" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-floating form-outline ">
                                                    <input type="text" required name="fname" autofocus id="fname"
                                                ...
                                                <div class="form-floating form-floating mb-3">
                                                    <input type="text" required name="uname" class="form-control" id="uname"
                                                        placeholder=" " value="<?php echo "$uname"; ?>">
                                                ...
                                                <div class="form-floating form-floating mb-3">
                                                    <input type="number" required name="phone" class="form-control"
                                                        id="phone" placeholder=" " value="<?php echo "$phone"; ?>" />
                                                    ...
                                                    <div class="col-md-6 mb-4">
                                                        <div class="form-floating form-outline">
                                                            <input accept="image/jpeg,image/png"
                                                                onchange="validateFileType()" type="file" id="file"
                                                                name="p_pic" value="Profile Picture" class="form-control"
                                                                placeholder=" " />
