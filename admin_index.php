                ...
                <nav class="navbar bg-light navbar-light">
                    ...
                    <div class="d-flex align-items-center ms-4 mb-4">
                        <div class="position-relative">
                            <img class="rounded-circle" src="uploaded files/Profile Pictures/<?php echo $target; ?>" alt="" style="width: 40px; height: 40px;">
            ...
            <div class="content">
                ...
                <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                    ...
                    <div class="navbar-nav align-items-center ms-auto">
                        ...
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                                <img class="rounded-circle me-lg-2" src="uploaded files/Profile Pictures/<?php echo $target; ?>" alt="" style="width: 40px; height: 40px;">
