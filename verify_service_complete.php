...
if (isset($_SESSION['l_id'])) {
    $requestID= base64_decode(urldecode($_GET['token']));
    ?>
    <!DOCTYPE html>
    <html lang="en">
                    ...
                    <div class="col-12 col-lg-9 col-xl-7">
                        <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                            <div class="card-body p-4 p-md-5">
                                <h3 class="mb-4 pb-2 pb-md-0 mb-md-5">Verify Completion</h3>
                                <form action="sp_verify_complete.php" method="POST">
                                    <input type="hidden" value="<?php echo $requestID ?>" name="requestID">
                                    <div class="form-floating form-outline mb-4">
                                        <input type="number" name="code" id="number" class="form-control" placeholder=" " />
                                        <span class="errornumber" id="erroremail"></span>
                                        <label class="form-label" for="mail">Enter Customer code</label>
                                        <?php if (isset($_SESSION["Check_login"])) {
                                            if ($_SESSION["Check_login"] == "INVALID_CODE") {
                                                ?>
                                    ...
                                    <button type="submit" id="sub" class="btn btn-primary btn-block mb-4" width="">
                                        <div class="spinner-border mfa-rotate-180" id="signup_loader"
                                            style="display: none;">
                                        </div><span class="signup_text">Verify</span>
                                    </button>
                                    <a href="send_completion_mail.php?requestID=<?php echo $requestID ?>" onclick="disableSubmit()">Resend verification Code</a>
                                </form>
                            </div>
                        </div>
                    </div>
